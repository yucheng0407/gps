...
public class StrKit {
     ...
     * @return bytes
     */
    public static byte[] getBytes(String str, Charset charset) throws UnsupportedEncodingException {
        if (null == str) {
            return null;
        }
        return null == charset ? str.getBytes("utf-8") : str.getBytes(charset);
    }
    ...
    public static boolean isSurround(String str, String prefix, String suffix) {
        return !StrKit.isBlank(str) && str.length() >= (prefix.length() + suffix.length()) && str.startsWith(prefix) && str.endsWith(suffix);
    ...
    public static boolean isSurround(String str, char prefix, char suffix) {
        return !StrKit.isBlank(str) && str.length() >= 2 && str.charAt(0) == prefix && str.charAt(str.length() - 1) == suffix;
     ...
     * @return 编码后的字节码
     */
    public static byte[] bytes(String str, String charset) throws UnsupportedEncodingException {
     ...
     * @return 编码后的字节码
     */
    public static byte[] bytes(String str, Charset charset) throws UnsupportedEncodingException {
        if (str == null) {
            return null;
        }
     ...
     * @return 字符串
     */
    public static String str(byte[] bytes, String charset) throws UnsupportedEncodingException {
     ...
     * @return 解码后的字符串
     */
    public static String str(byte[] data, Charset charset) throws UnsupportedEncodingException {
        if (data == null) {
            return null;
        }
     ...
     * @return byteBuffer
     */
    public static ByteBuffer byteBuffer(String str, String charset) throws UnsupportedEncodingException {
