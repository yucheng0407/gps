...
public class HexKit {
     ...
     * @return 十六进制char[]
     */
    public static char[] encodeHex(String str, Charset charset) throws UnsupportedEncodingException {
     ...
     * @return 字符串
     */
    public static String decodeHexStr(String hexStr, Charset charset) throws UnsupportedEncodingException {
     ...
     * @return 字符串
     */
    public static String decodeHexStr(char[] hexData, Charset charset) throws UnsupportedEncodingException {
